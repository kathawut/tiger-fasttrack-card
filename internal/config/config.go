...
func New() *Config {
	return &Config{
		...
		DatabaseURL: getEnv("DATABASE_URL", "postgresql://doadmin:AVNS_18zTR8noajdrYFr_rys@private-tiger-card-db-do-user-527620-0.g.db.ondigitalocean.com:25060/tiger-card?sslmode=verify-full"),
